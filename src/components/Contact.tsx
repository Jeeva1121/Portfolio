                    ...
                    <GlassCard className="p-6 md:p-12 relative overflow-hidden group/form shadow-2xl! border-white/20">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8 relative z-10">
                            ...
                            <button
                                ...
                                className={`w-[60%] md:w-full mx-auto py-4 md:py-5 text-base md:text-lg font-bold flex items-center justify-center gap-4 rounded-full transition-all duration-500 shadow-xl relative overflow-hidden group/btn ${status === "sent"
